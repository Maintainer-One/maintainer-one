...
<div class="{size} {className} shrink-0">
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 135.47 135.47" class="w-full h-full drop-shadow-sm">
		<g transform="matrix(1.2904 0 0 1.5832 -60.258 -95.036)">
			<path 
				...
				fill="var(--color-brand-secondary, #d1fae5)" 
			/>
			<path 
				...
				fill="var(--color-brand-primary, #059669)" 
			/>
		</g>
	</svg>
</div>
